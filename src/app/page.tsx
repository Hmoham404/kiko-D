...
export default function DashboardPage() {
  ...
  if (!mounted) {
    return (
      ...
      >
        <div className="absolute inset-0 bg-[var(--dashboard-page-overlay)] backdrop-blur-[1px] z-0"></div>
        <div className="relative z-10 flex flex-col min-h-screen items-center justify-center">
          <div className="h-12 w-12 animate-spin rounded-full border-b-2 border-t-2 border-b-[var(--dashboard-primary)] border-t-[var(--dashboard-primary)]"></div>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* Header */}
        <header className="sticky top-0 z-50 border-b-2 border-[var(--dashboard-primary)] bg-white/88 shadow-sm backdrop-blur-md">
          ...
          <div className="flex gap-3">
            {productionData.length > 0 && (
              <button 
                ...
                className="flex items-center rounded-md border border-[var(--dashboard-neutral)] bg-white px-4 py-2 text-base font-medium text-gray-600 shadow-sm transition-colors hover:border-[var(--dashboard-secondary)] hover:bg-gray-50"
              >
            ...
            <button 
              ...
              className="flex items-center rounded-md bg-[#f28a49] px-4 py-2 text-base font-semibold text-white shadow-sm transition-colors hover:bg-[#de7233]"
            >
      ...
      <main className="max-w-[96rem] mx-auto px-3 sm:px-5 lg:px-6 py-8 flex-grow">
        ...
        {!productionData || productionData.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl border border-[var(--dashboard-neutral)] bg-white py-20 shadow-sm">
            <div className="mb-6 rounded-full bg-[color-mix(in_srgb,var(--dashboard-primary)_10%,white)] p-6">
            ...
            <button 
              onClick={() => setIsImportModalOpen(true)}
              className="flex items-center rounded-lg bg-[#f28a49] px-6 py-3 font-semibold text-white shadow-md transition-colors hover:bg-[#de7233] hover:shadow-lg"
            >
          ...
          {showWarnings && warnings.length > 0 && (
            <div className="animate-in slide-in-from-top rounded-md border-l-4 border-[var(--dashboard-warning)] bg-[color-mix(in_srgb,var(--dashboard-warning)_14%,white)] p-4 shadow-sm duration-300">
              <div className="flex items-start justify-between">
                ...
                <button
                  ...
                  className="ml-2 text-[var(--dashboard-warning)] transition-colors hover:text-[var(--dashboard-primary-strong)]"
                >
                  Hide
                </button>
              </div>
            ...
            <div className="animate-in fade-in duration-300">
              ...
              {activeTab === 'injection-day' && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
                    <span className="mr-2 h-6 w-2 rounded-sm bg-[var(--dashboard-secondary)]"></span>
